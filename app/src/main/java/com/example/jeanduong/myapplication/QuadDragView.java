...
public class QuadDragView extends View {
    ...
    public QuadDragView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void drawVertices(Canvas cv){
        ...
        cv.drawCircle(x_1, y_1, 20, pt);
        cv.drawCircle(x_2, y_2, 20, pt);
        cv.drawCircle(x_3, y_3, 20, pt);
        cv.drawCircle(x_4, y_4, 20, pt);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ph.reset();
                ph.addCircle(x_touch, y_touch, 20, Path.Direction.CCW);
                break;
